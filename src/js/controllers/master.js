...
function MasterCtrl($rootScope,$scope, $cookieStore,Auth,envService,Idle) {
     ...
     */
     ...
     // if($scope.user.product == 'addoo' || $scope.user.product == 'demo') {
        ...
        //         app_id : "",
        //         email : envService.read('inappuser')
        //     }
        ...
        //     var loadAddooPlugin = function() {
        //         var addoo = document.createElement('script');
        //         addoo.type = 'text/javascript';
        //         addoo.async = true;
        //         addoo.src = envService.read('inappserverurl');
        //         addoo.id = "addoo";
        ...
        //     window.addEventListener("load", loadAddooPlugin, false);
        // })();

        // if(window.Addoo) {
        //         console.log('Got Addoooo :'+window.Addoo);
        // } else {
        //         console.log("Could not find Addoo :"+window.Addoo)
        // }

    window.AddooSettings = {
        email : "inapp15@grr.la",
        //walkme : true,
        product : 'addoo'
